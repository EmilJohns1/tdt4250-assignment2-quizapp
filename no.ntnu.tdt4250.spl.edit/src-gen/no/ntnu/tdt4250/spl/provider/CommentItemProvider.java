...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.spl.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Comment_content_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Comment_content_feature",
								"_UI_Comment_type"),
						SplPackage.Literals.COMMENT__CONTENT, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Comment_author_feature",
								"_UI_Comment_type"),
						SplPackage.Literals.COMMENT__AUTHOR, true, false, true, null, null, null));
	}
	...
	protected void addQuizPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Comment_quiz_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Comment_quiz_feature", "_UI_Comment_type"),
						SplPackage.Literals.COMMENT__QUIZ, true, false, true, null, null, null));
	}
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SplPackage.Literals.COMMENT__ID, true, false, false,
	...
	protected void addTimestampPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Comment_timestamp_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Comment_timestamp_feature",
								"_UI_Comment_type"),
						SplPackage.Literals.COMMENT__TIMESTAMP, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Comment_type") + " " + comment.getId();
	}
