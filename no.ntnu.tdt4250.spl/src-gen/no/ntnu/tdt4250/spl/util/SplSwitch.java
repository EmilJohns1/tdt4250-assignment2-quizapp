 ...
 * @generated
 */
public class SplSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SplPackage.LOGGED_IN_USER: {
			LoggedInUser loggedInUser = (LoggedInUser) theEObject;
			T result = caseLoggedInUser(loggedInUser);
			if (result == null)
				result = caseUser(loggedInUser);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SplPackage.QUIZ_APP: {
			QuizApp quizApp = (QuizApp) theEObject;
			T result = caseQuizApp(quizApp);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Logged In User</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Logged In User</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLoggedInUser(LoggedInUser object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quiz App</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quiz App</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQuizApp(QuizApp object) {
		return null;
	}
